...
################################################################
# Test the closer with naive opener
# trained on a one on-fly sample generator.
################################################################
...
test_env = CompositeEnv(test_df, opener_price_diff_generator, buyer_price_diff_generator, seller_price_diff_generator,
                       ...
                       render_dir="../../data/pictures", render_name="supervised_mirror_closer", env_name="test_env", turn_off_spread=True)
