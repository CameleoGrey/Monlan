...
testEnv = CompositeEnv(testDf, openerPriceDiffGenerator, buyerPriceDiffGenerator, sellerPriceDiffGenerator,
                       ...
                       stopType="adaptive", takeType="adaptive", stopPos=3, takePos=3, maxLoss=20000, maxTake=20000,
                       stoplossPuncts=100, takeprofitPuncts=200, riskPoints=110, riskLevels=5, parallelOpener=False,
