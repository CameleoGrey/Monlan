...
featureGenerator = W2VDiffGenerator(featureList=obsFeatList, nDiffs=1, nPoints = 40, flatStack = False, fitOnStep = False,
...
openerFeatureFactory = W2VDiffGenerator(featureList=obsFeatList).loadGenerator("./w2vGen.pkl")
buyerFeatureFactory = W2VDiffGenerator(featureList=obsFeatList).loadGenerator("./w2vGen.pkl")
sellerFatureFactory = W2VDiffGenerator(featureList=obsFeatList).loadGenerator("./w2vGen.pkl")
