...
testDf = mod_df.tail(250000).head(200000)
...
agent  = load( os.path.join("../../models/", "composite_agent_13.pkl"))
...
for i in tqdm(range(start_point, len(testDf) - 2), desc="Collecting seller statistics"):
