...
def loadDataSet(dir, agentType, symbol, timeframe):
    ...
    #x = load("{}2d_feat_images_{}_{}_{}.pkl".format(dir, agentType, symbol, timeframe))
    # x = x[int(0.5 * len(x)):]
    #y = load("{}2d_feat_images_{}_y_{}_{}.pkl".format(dir, agentType, symbol, timeframe))
    # y = y[int(0.5 * len(y)):]
    gc.collect()
    return x, y
...
for agentType in agentTypes:
    ...
    my_callbacks = [
        ...
        tf.keras.callbacks.ModelCheckpoint(filepath="../models/super_resnet_34_{}_{}_{}".format(targetSymbol, timeframe, agentType) + ".h5",
