...
from classes.delta_bender.agents.DBAgentOpener_PEMA import DBAgentOpener_PEMA
from classes.delta_bender.agents.DBAgentBuyer_PEMA import DBAgentBuyer_PEMA
from classes.delta_bender.agents.DBAgentSeller_PEMA import DBAgentSeller_PEMA
...
testEnv = CompositeEnv(df, openerPriceDiffGenerator, buyerPriceDiffGenerator, sellerPriceDiffGenerator,
                       ...
                       stopType="const", takeType="const", stopPos=2, takePos=2, maxLoss=2000, maxTake=2000,
                       stoplossPuncts=80, takeprofitPuncts=50, riskPoints=32, riskLevels=5, parallelOpener=False,
...
model.load_weights( "../models/resnet_jc_no_cake_sigmoid" + ".h5" )

openerAgent = DBAgentOpener_PEMA(agentName="opener", model=model)
buyerAgent = DBAgentBuyer_PEMA(agentName="buyer", model=model)
sellerAgent = DBAgentSeller_PEMA(agentName="seller", model=model)
