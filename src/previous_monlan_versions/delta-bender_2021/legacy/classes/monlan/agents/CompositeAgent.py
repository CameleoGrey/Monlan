...
class CompositeAgent():
    ...
    # repeat opener cycle
    def fit_agent(self, env, nEpisodes, plotScores, saveBest = True, saveFreq=5, nWarmUp=0, fillMemoryByPretrainedModel = False,
    ...
    def loadPretrainedAgents(self, dir, baseName):

        self.agents["opener"] = self.agents["opener"].loadPretrainedWeights(dir, baseName, "opener")
        self.agents["buy"] = self.agents["buy"].loadPretrainedWeights(dir, baseName, "buyer")
        self.agents["sell"] = self.agents["sell"].loadPretrainedWeights(dir, baseName, "seller")
        self.nSteps = {"opener": 0, "buy": 0, "sell": 0}
        self.activeAgent = "opener"
