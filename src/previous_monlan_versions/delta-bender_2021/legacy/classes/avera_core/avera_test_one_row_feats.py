...
trainDf = modDf.tail(200000).head(160000)
trainEnv = AveraCompositeEnv(trainDf, openerPriceDiffGenerator, buyerPriceDiffGenerator, sellerPriceDiffGenerator,
                        ...
                        stoplossPuncts=20000, takeprofitPuncts=20000, renderFlag=True, renderDir="./", renderName="train_plot")
backTestDf = modDf.tail(200000).tail(40000)
...
testDf = modDf.tail(200000).tail(200000)
