...
class DistilledTCNMirrorOpener:
    ...
    def fit(self, buyer_samples, seller_samples,
        ...
        #model = load( os.path.join( "../../models", "best_val_distilled_tcn_mirror_opener.pkl" ) ).model #continue training
    ...
    def build_train_val_dataset_(self, buyer_samples, seller_samples):
        ...
        train_x, val_x, train_y, val_y = train_test_split(x, y, shuffle=True, test_size=0.2, random_state=45)
