...
import os
from src.monlan.modular_agents.NaiveDistilledMultiHybridOpener import NaiveDistilledMultiHybridMirrorOpener
...
test_env = CompositeEnv(test_df, opener_price_diff_generator, buyer_price_diff_generator, seller_price_diff_generator,
                        ...
                        render_dir="../../../../../data/pictures", render_name="distilled_multi_hybrid_mirror_closer", env_name="test_env", turn_off_spread=False)


composite_agent = load(os.path.join("../../../../../models/", "kaiming_composite_agent_7.pkl"))

mirror_closer = load(os.path.join("../../../../../models", "distilled_multi_hybrid_mirror_closer.pkl"))
hybrid_opener = NaiveDistilledMultiHybridMirrorOpener(composite_agent.agents["buyer"], composite_agent.agents["seller"])
hybrid_opener.regression_model = mirror_closer.regression_model
hybrid_opener.action_size = 3
hybrid_opener.name = "opener"
composite_agent.agents["opener"] = hybrid_opener

tcn_mirror_buyer = load(os.path.join("../../../../../models", "distilled_multi_hybrid_mirror_closer.pkl"))
tcn_mirror_buyer.name = "buyer"
composite_agent.agents["buyer"] = tcn_mirror_buyer

tcn_mirror_seller = load(os.path.join("../../../../../models", "distilled_multi_hybrid_mirror_closer.pkl"))
