...
test_env = CompositeEnv(test_df, opener_price_diff_generator, buyer_price_diff_generator, seller_price_diff_generator,
                        ...
                        render_dir="../../../../../data/pictures", render_name="distilled_hybrid_mirror_closer", env_name="test_env", turn_off_spread=False)


composite_agent = load(os.path.join("../../../../../models/", "kaiming_composite_agent_7.pkl"))

tcn_mirror_buyer = load(os.path.join("../../../../../models", "distilled_hybrid_mirror_closer.pkl"))
tcn_mirror_buyer.name = "buyer"
composite_agent.agents["buyer"] = tcn_mirror_buyer

tcn_mirror_seller = load(os.path.join("../../../../../models", "distilled_hybrid_mirror_closer.pkl"))
