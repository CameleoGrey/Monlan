...
from src.monlan.modular_agents.DistilledHybridMirrorCloser import DistilledHybridMirrorCloser

composite_agent = load(os.path.join("../../../../../models/", "kaiming_composite_agent_7.pkl"))
closer = DistilledHybridMirrorCloser(buyer_rl_agent=composite_agent.agents["buyer"],
...
save(closer, os.path.join("../../../../../models", "distilled_hybrid_mirror_closer.pkl"))
print("done")
