...
test_env = CompositeEnv(test_df, opener_price_diff_generator, buyer_price_diff_generator, seller_price_diff_generator,
                        ...
                        render_dir="../../../../../data/pictures", render_name="distilled_full_tcn_agent", env_name="test_env", turn_off_spread=True)


composite_agent = load(os.path.join("../../../../../models/", "kaiming_composite_agent_7.pkl"))

composite_agent.agents["opener"] = load(os.path.join("../../../../../models", "best_val_distilled_tcn_mirror_opener.pkl"))
...
#composite_agent.agents["buyer"] = AlwaysHoldAgent(name="buyer", state_size=None)
...
#composite_agent.agents["seller"] = AlwaysHoldAgent(name="seller", state_size=None)
