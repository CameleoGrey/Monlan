...
class BigSupervisedTCNMirrorOpener:
    ...
    def fit(self, sample_generator, n_jobs=0, val_size=0.03, val_batch_size=256,
            ...
            checkpoint_save_path = os.path.join("../../models", "best_val_big_supervised_tcn_mirror_opener.pkl"),
            continue_train = True):
    ...
    def get_action(self, state):
        ...
        ####
        q_value = q_value[0]
        q_value[1] = 1.0 * abs(q_value[1]) # modify hold
        greed_action_id = np.argmax(q_value)
        return greed_action_id
